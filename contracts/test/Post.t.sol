...
//         string memory duration = "1 week";
//         uint256 date = 1677645600; // some arbitrary date
//         uint256 price = 20;
//         bool status = true;
//         address[] memory interestedFreelancers = new address[](0);

//         post.createPost(title, content, date, price, duration);
...
//         assertEq(retrievedPost.postStatus, status);
//         assertEq(retrievedPost.interestedFreelancers.length, 0, "No interested freelancers initially");
//     }
...
// function testGetInterestedFreelancers() public {
//     // string memory content = "This is a test post!";
//     // uint256 date = 1677645600; // some arbitrary date
//     // string memory sector = "Tech";
...
//     post.expressInterest(1);

//     address[] memory freelancers = post.getInterestedFreelancers(1);

//     assertEq(freelancers.length, 0);
// }
